document.addEventListener("DOMContentLoaded", () => {
  ...
  viewPhotoBtn.addEventListener("click", () => {
    fadeSwap(writtenSection, `
      <p class="photograph-title">My Grandparents — 01.11.2005</p>
 <img class="photograph" src="images/Entry-imgs-full/full-img/cara-full.png" alt="photograph" style="max-width:100%;">
    `);
