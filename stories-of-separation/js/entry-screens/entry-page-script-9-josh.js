document.addEventListener("DOMContentLoaded", () => {
  ...
  viewPhotoBtn.addEventListener("click", () => {
    fadeSwap(writtenSection, `
      <p class="photograph-title">My Dad and Mum— 04.02.2009</p>
 <img class="photograph" src="images/Entry-imgs-full/full-img/josh-full.png" alt="photograph" style="max-width:100%;">
    `);
