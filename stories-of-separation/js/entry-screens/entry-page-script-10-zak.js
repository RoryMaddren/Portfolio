document.addEventListener("DOMContentLoaded", () => {
  ...
  viewPhotoBtn.addEventListener("click", () => {
    fadeSwap(writtenSection, `
      <p class="photograph-title">My Zak Back in the Day 21.09.2076</p>
 <img class="photograph" src="images/Entry-imgs-full/full-img/zak-full.png" alt="photograph" style="max-width:100%;">
    `);
