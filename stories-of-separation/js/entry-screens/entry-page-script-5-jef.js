document.addEventListener("DOMContentLoaded", () => {
  ...
  viewPhotoBtn.addEventListener("click", () => {
    fadeSwap(writtenSection, `
      <p class="photograph-title">Me and my Sister — 01.11.2005</p>
 <img class="photograph" src="images/Entry-imgs-full/full-img/jeffritz-full.png" alt="photograph" style="max-width:100%;">
    `);
