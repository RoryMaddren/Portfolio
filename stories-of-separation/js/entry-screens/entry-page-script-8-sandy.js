document.addEventListener("DOMContentLoaded", () => {
  ...
  viewPhotoBtn.addEventListener("click", () => {
    fadeSwap(writtenSection, `
      <p class="photograph-title">My dad — 11.04.2012</p>
 <img class="photograph" src="images/Entry-imgs-full/full-img/sandy-full.png" alt="photograph" style="max-width:100%;">
    `);
