document.addEventListener("DOMContentLoaded", () => {
  ...
  viewPhotoBtn.addEventListener("click", () => {
    fadeSwap(writtenSection, `
      <p class="photograph-title"Me and her — 12.05.2009</p>
 <img class="photograph" src="images/Entry-imgs-full/full-img/eiffel-full.png" alt="photograph" style="max-width:100%;">
    `);
